    ...
    <section className="mt-40 mb-32 px-4">
      ...
      <div className="mx-auto max-w-[1109px] flex flex-col lg:flex-row justify-between gap-8 h-auto lg:h-[455px] px-4 md:px-0">
        ...
        <div className="w-full lg:w-[55%] h-auto lg:h-[366px] flex flex-col justify-center">
          <p className="text-[14px] font-normal leading-[21px] text-primary">
            Our Amazing Story
          </p>
          <p className="text-[28px] lg:text-[36px] font-bold leading-[38px] lg:leading-[46px] text-primary mt-4 mb-6 lg:mb-10">
            10k+ Happy Customers
          </p>
          ...
          <div className="flex items-center gap-1 mt-6">
            <FontAwesomeIcon
              icon={faCaretRight}
              className="text-primary w-[10px] h-[13px]"
            />
            <p className="text-[15px] lg:text-[16px] font-bold leading-[24px] text-primary  underline">
            Know More About Us
          </p>
          </div>
        ...
        <div className="flex flex-col justify-between w-full sm:w-[80%] md:w-[60%] lg:w-[475px] h-auto lg:h-[455px] bg-cardBg px-6 py-10 mt-8 lg:mt-0 shadow-2xl cardHover mx-auto">
          ...
          <div className="flex gap-8 items-center mt-6">
            ...
            <div className="flex flex-col gap-3">
              <p className="text-[18px] md:text-[22px] font-bold leading-[28px] md:leading-[33px] text-secondary-custom">
                James Miller
              </p>
              <p className="text-[14px] md:text-[16px] font-normal leading-[20px] md:leading-[24px] text-tertiary">
                CEO, Techbias
              </p>
