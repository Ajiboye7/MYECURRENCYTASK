...
const Story = () => {
  return (
    <section className=' mt-32 px-4'>
      <div className='mx-auto max-w-[1109px] flex flex-col lg:flex-row justify-between h-auto lg:h-[455px]'>
        ...
        <div className='w-full lg:w-[475px] h-auto lg:h-[366px] flex flex-col justify-center'>
          ...
          <p className='text-[36px] font-bold leading-[46px] text-primary mt-4 mb-10'>10k+ Happy Customers</p>
          ...
          <p className='text-[16px] font-bold leading-[24px] text-primary mt-6 underline'>Know More About Us</p>
        </div>

        {/* Right Section */}
        <div className=' flex flex-col justify-between w-full lg:w-[475px] h-auto lg:h-[455px] bg-cardBg px-6 py-10  mt-8 lg:mt-0 shadow-2xl cardHover'>
          <p className='text-[24px] italic font-normal leading-[40px] text-secondary-custom'>
